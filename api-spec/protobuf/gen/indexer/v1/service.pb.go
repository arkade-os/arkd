...
const file_indexer_v1_service_proto_rawDesc = "" +
	...
	"\x0fGetSubscription\x12\".indexer.v1.GetSubscriptionRequest\x1a#.indexer.v1.GetSubscriptionResponse\"4\xb2J1b\x04\b\x01\x18\x01\x12)/v1/script/subscription/{subscription_id}0\x01B\x97\x01\n" +
	"\x0ecom.indexer.v1B\fServiceProtoP\x01Z.github.com/arkade-os/arkd/indexer/v1;indexerv1\xa2\x02\x03IXX\xaa\x02\n" +
	"Indexer.V1\xca\x02\n" +
