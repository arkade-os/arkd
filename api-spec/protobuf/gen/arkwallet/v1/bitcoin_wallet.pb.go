...
const file_arkwallet_v1_bitcoin_wallet_proto_rawDesc = "" +
	"\n" +
	"!arkwallet/v1/bitcoin_wallet.proto\x12\farkwallet.v1\x1a\x1cgoogle/api/annotations.proto\"\x17\n" +
	...
	"\tblocktime\x18\x03 \x01(\x03R\tblocktime\"\x1b\n" +
	...
	"\x06pubkey\x18\x01 \x01(\fR\x06pubkey\"\x13\n" +
	"\x11GetNetworkRequest\".\n" +
	"\x12GetNetworkResponse\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\"\x1a\n" +
	"\x18GetForfeitAddressRequest\"5\n" +
	"\x19GetForfeitAddressResponse\x12\x18\n" +
	...
	"\ttimestamp\x18\x01 \x01(\v2\x1c.arkwallet.v1.BlockTimestampR\ttimestamp\"C\n" +
	...
	"\x04time\x18\x02 \x01(\x03R\x04time2\x85!\n" +
	"\rWalletService\x12_\n" +
	"\aGenSeed\x12\x1c.arkwallet.v1.GenSeedRequest\x1a\x1d.arkwallet.v1.GenSeedResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/wallet/seed\x12a\n" +
	"\x06Create\x12\x1b.arkwallet.v1.CreateRequest\x1a\x1c.arkwallet.v1.CreateResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/wallet/create\x12e\n" +
	"\aRestore\x12\x1c.arkwallet.v1.RestoreRequest\x1a\x1d.arkwallet.v1.RestoreResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/wallet/restore\x12a\n" +
	"\x06Unlock\x12\x1b.arkwallet.v1.UnlockRequest\x1a\x1c.arkwallet.v1.UnlockResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/wallet/unlock\x12Y\n" +
	"\x04Lock\x12\x19.arkwallet.v1.LockRequest\x1a\x1a.arkwallet.v1.LockResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/wallet/lock\x12^\n" +
	"\x06Status\x12\x1b.arkwallet.v1.StatusRequest\x1a\x1c.arkwallet.v1.StatusResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/wallet/status\x12g\n" +
	"\tGetPubkey\x12\x1e.arkwallet.v1.GetPubkeyRequest\x1a\x1f.arkwallet.v1.GetPubkeyResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/wallet/pubkey\x12k\n" +
	"\n" +
	"GetNetwork\x12\x1f.arkwallet.v1.GetNetworkRequest\x1a .arkwallet.v1.GetNetworkResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/wallet/network\x12\x88\x01\n" +
	"\x11GetForfeitAddress\x12&.arkwallet.v1.GetForfeitAddressRequest\x1a'.arkwallet.v1.GetForfeitAddressResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/wallet/forfeit-address\x12\x99\x01\n" +
	"\x16DeriveConnectorAddress\x12+.arkwallet.v1.DeriveConnectorAddressRequest\x1a,.arkwallet.v1.DeriveConnectorAddressResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/wallet/connector-address\x12\x86\x01\n" +
	"\x0fDeriveAddresses\x12$.arkwallet.v1.DeriveAddressesRequest\x1a%.arkwallet.v1.DeriveAddressesResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/wallet/derive-addresses\x12\x86\x01\n" +
	"\x0fSignTransaction\x12$.arkwallet.v1.SignTransactionRequest\x1a%.arkwallet.v1.SignTransactionResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/wallet/sign-transaction\x12\xab\x01\n" +
	"\x18SignTransactionTapscript\x12-.arkwallet.v1.SignTransactionTapscriptRequest\x1a..arkwallet.v1.SignTransactionTapscriptResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/wallet/sign-transaction-tapscript\x12v\n" +
	"\vSelectUtxos\x12 .arkwallet.v1.SelectUtxosRequest\x1a!.arkwallet.v1.SelectUtxosResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/wallet/select-utxos\x12\x8e\x01\n" +
	"\x14BroadcastTransaction\x12).arkwallet.v1.BroadcastTransactionRequest\x1a*.arkwallet.v1.BroadcastTransactionResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/wallet/broadcast\x12w\n" +
	"\vWaitForSync\x12 .arkwallet.v1.WaitForSyncRequest\x1a!.arkwallet.v1.WaitForSyncResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/wallet/wait-for-sync\x12~\n" +
	"\x0eGetReadyUpdate\x12#.arkwallet.v1.GetReadyUpdateRequest\x1a$.arkwallet.v1.GetReadyUpdateResponse\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/v1/wallet/ready-update0\x01\x12\x9d\x01\n" +
	"\x16IsTransactionConfirmed\x12+.arkwallet.v1.IsTransactionConfirmedRequest\x1a,.arkwallet.v1.IsTransactionConfirmedResponse\"(\x82\xd3\xe4\x93\x02\"\x12 /v1/wallet/transaction-confirmed\x12z\n" +
	"\fEstimateFees\x12!.arkwallet.v1.EstimateFeesRequest\x1a\".arkwallet.v1.EstimateFeesResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/wallet/estimate-fees\x12c\n" +
	"\aFeeRate\x12\x1c.arkwallet.v1.FeeRateRequest\x1a\x1d.arkwallet.v1.FeeRateResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/v1/wallet/fee-rate\x12\x8b\x01\n" +
	"\x12ListConnectorUtxos\x12'.arkwallet.v1.ListConnectorUtxosRequest\x1a(.arkwallet.v1.ListConnectorUtxosResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/wallet/connector-utxos\x12\x90\x01\n" +
	"\x12MainAccountBalance\x12'.arkwallet.v1.MainAccountBalanceRequest\x1a(.arkwallet.v1.MainAccountBalanceResponse\"'\x82\xd3\xe4\x93\x02!\x12\x1f/v1/wallet/main-account-balance\x12\xa8\x01\n" +
	"\x18ConnectorsAccountBalance\x12-.arkwallet.v1.ConnectorsAccountBalanceRequest\x1a..arkwallet.v1.ConnectorsAccountBalanceResponse\"-\x82\xd3\xe4\x93\x02'\x12%/v1/wallet/connectors-account-balance\x12\x93\x01\n" +
	"\x12LockConnectorUtxos\x12'.arkwallet.v1.LockConnectorUtxosRequest\x1a(.arkwallet.v1.LockConnectorUtxosResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/wallet/lock-connector-utxos\x12q\n" +
	"\rGetDustAmount\x12\".arkwallet.v1.GetDustAmountRequest\x1a#.arkwallet.v1.GetDustAmountResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/wallet/dust\x12r\n" +
	"\x0eGetTransaction\x12#.arkwallet.v1.GetTransactionRequest\x1a$.arkwallet.v1.GetTransactionResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/wallet/tx\x12v\n" +
	"\vSignMessage\x12 .arkwallet.v1.SignMessageRequest\x1a!.arkwallet.v1.SignMessageResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/wallet/sign-message\x12\xa3\x01\n" +
	"\x16VerifyMessageSignature\x12+.arkwallet.v1.VerifyMessageSignatureRequest\x1a,.arkwallet.v1.VerifyMessageSignatureResponse\".\x82\xd3\xe4\x93\x02(:\x01*\"#/v1/wallet/verify-message-signature\x12\x89\x01\n" +
	"\x13GetCurrentBlockTime\x12(.arkwallet.v1.GetCurrentBlockTimeRequest\x1a).arkwallet.v1.GetCurrentBlockTimeResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/wallet/block-time\x12i\n" +
	"\bWithdraw\x12\x1d.arkwallet.v1.WithdrawRequest\x1a\x1e.arkwallet.v1.WithdrawResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/wallet/withdraw\x12z\n" +
	"\fWatchScripts\x12!.arkwallet.v1.WatchScriptsRequest\x1a\".arkwallet.v1.WatchScriptsResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/wallet/watch-scripts\x12\x82\x01\n" +
	"\x0eUnwatchScripts\x12#.arkwallet.v1.UnwatchScriptsRequest\x1a$.arkwallet.v1.UnwatchScriptsResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/wallet/unwatch-scripts\x12\x8b\x01\n" +
	"\x12NotificationStream\x12'.arkwallet.v1.NotificationStreamRequest\x1a(.arkwallet.v1.NotificationStreamResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/wallet/notifications0\x01B\xab\x01\n" +
