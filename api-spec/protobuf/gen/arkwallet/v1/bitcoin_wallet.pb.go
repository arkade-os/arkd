...
const file_arkwallet_v1_bitcoin_wallet_proto_rawDesc = "" +
	...
	"\x04time\x18\x02 \x01(\x03R\x04time2\xa1 \n" +
	"\rWalletService\x12\\\n" +
	...
	"\x06Status\x12\x1b.arkwallet.v1.StatusRequest\x1a\x1c.arkwallet.v1.StatusResponse\"\x16\xb2J\x13\x12\x11/v1/wallet/status\x12d\n" +
	"\tGetPubkey\x12\x1e.arkwallet.v1.GetPubkeyRequest\x1a\x1f.arkwallet.v1.GetPubkeyResponse\"\x16\xb2J\x13\x12\x11/v1/wallet/pubkey\x12h\n" +
	"\n" +
	"GetNetwork\x12\x1f.arkwallet.v1.GetNetworkRequest\x1a .arkwallet.v1.GetNetworkResponse\"\x17\xb2J\x14\x12\x12/v1/wallet/network\x12\x85\x01\n" +
	"\x11GetForfeitAddress\x12&.arkwallet.v1.GetForfeitAddressRequest\x1a'.arkwallet.v1.GetForfeitAddressResponse\"\x1f\xb2J\x1c\x12\x1a/v1/wallet/forfeit-address\x12\x96\x01\n" +
	...
	"\x14BroadcastTransaction\x12).arkwallet.v1.BroadcastTransactionRequest\x1a*.arkwallet.v1.BroadcastTransactionResponse\"\x1c\xb2J\x19B\x01*\"\x14/v1/wallet/broadcast\x12t\n" +
	"\vWaitForSync\x12 .arkwallet.v1.WaitForSyncRequest\x1a!.arkwallet.v1.WaitForSyncResponse\" \xb2J\x1dB\x01*\"\x18/v1/wallet/wait-for-sync\x12{\n" +
	...
	"\x16IsTransactionConfirmed\x12+.arkwallet.v1.IsTransactionConfirmedRequest\x1a,.arkwallet.v1.IsTransactionConfirmedResponse\"%\xb2J\"\x12 /v1/wallet/transaction-confirmed\x12w\n" +
	...
	"\x12NotificationStream\x12'.arkwallet.v1.NotificationStreamRequest\x1a(.arkwallet.v1.NotificationStreamResponse\"\x1d\xb2J\x1a\x12\x18/v1/wallet/notifications0\x01B\xab\x01\n" +
