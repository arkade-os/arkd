...
const file_ark_v1_admin_proto_rawDesc = "" +
	"\n" +
	"\x12ark/v1/admin.proto\x12\x06ark.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x12ark/v1/types.proto\"\x1a\n" +
	...
	"\vdestination2\x95\a\n" +
	"\fAdminService\x12r\n" +
	"\x11GetScheduledSweep\x12 .ark.v1.GetScheduledSweepRequest\x1a!.ark.v1.GetScheduledSweepResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/admin/sweeps\x12v\n" +
	"\x0fGetRoundDetails\x12\x1e.ark.v1.GetRoundDetailsRequest\x1a\x1f.ark.v1.GetRoundDetailsResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/admin/round/{round_id}\x12Z\n" +
	"\tGetRounds\x12\x18.ark.v1.GetRoundsRequest\x1a\x19.ark.v1.GetRoundsResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/admin/rounds\x12^\n" +
	"\n" +
	"CreateNote\x12\x19.ark.v1.CreateNoteRequest\x1a\x1a.ark.v1.CreateNoteResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/admin/note\x12|\n" +
	"\x13GetMarketHourConfig\x12\".ark.v1.GetMarketHourConfigRequest\x1a#.ark.v1.GetMarketHourConfigResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/admin/marketHour\x12\x88\x01\n" +
	"\x16UpdateMarketHourConfig\x12%.ark.v1.UpdateMarketHourConfigRequest\x1a&.ark.v1.UpdateMarketHourConfigResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/admin/marketHour\x12a\n" +
	"\vListIntents\x12\x1a.ark.v1.ListIntentsRequest\x1a\x1b.ark.v1.ListIntentsResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/admin/intents\x12q\n" +
	"\rDeleteIntents\x12\x1c.ark.v1.DeleteIntentsRequest\x1a\x1d.ark.v1.DeleteIntentsResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/admin/intents/deleteBy\n" +
	"\n" +
	"com.ark.v1B\n" +
