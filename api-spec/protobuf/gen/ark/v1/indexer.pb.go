...
const file_ark_v1_indexer_proto_rawDesc = "" +
	...
	"\x0fGetSubscription\x12\x1e.ark.v1.GetSubscriptionRequest\x1a\x1f.ark.v1.GetSubscriptionResponse\"1\x82\xd3\xe4\x93\x02+\x12)/v1/script/subscription/{subscription_id}0\x01B{\n" +
	"\n" +
