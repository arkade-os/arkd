...
const file_ark_v1_indexer_proto_rawDesc = "" +
	...
	"\"INDEXER_CHAINED_TX_TYPE_CHECKPOINT\x10\x042\x81\x0f\n" +
	...
	"\x0fGetSubscription\x12\x1e.ark.v1.GetSubscriptionRequest\x1a\x1f.ark.v1.GetSubscriptionResponse\"<\xb2J9b\x04\b\x01\x18\x01\x121/v1/indexer/script/subscription/{subscription_id}0\x01\x12\x9a\x01\n" +
