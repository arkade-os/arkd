...
type GetInfoResponse struct {
	...
	NostrPubkey         string                 `protobuf:"bytes,22,opt,name=nostr_pubkey,json=nostrPubkey,proto3" json:"nostr_pubkey,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *GetInfoResponse) GetNostrPubkey() string {
	if x != nil {
		return x.NostrPubkey
	}
	return ""
}
...
const file_ark_v1_service_proto_rawDesc = "" +
	...
	"\fnostr_pubkey\x18\x16 \x01(\tR\vnostrPubkey\x1a@\n" +
