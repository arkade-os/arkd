...
func (x *GetPendingTxRequest) GetTxid() string {
	if x != nil {
		if x, ok := x.Identifier.(*GetPendingTxRequest_Txid); ok {
			return x.Txid
		}
	}
	return ""
...
type GetPendingTxRequest_Txid struct {
	Txid string `protobuf:"bytes,2,opt,name=txid,proto3,oneof"`
}

func (*GetPendingTxRequest_Intent) isGetPendingTxRequest_Identifier() {}

func (*GetPendingTxRequest_Txid) isGetPendingTxRequest_Identifier() {}
...
const file_ark_v1_service_proto_rawDesc = "" +
	...
	"\x12FinalizeTxResponse\"c\n" +
	"\x13GetPendingTxRequest\x12(\n" +
	"\x06intent\x18\x01 \x01(\v2\x0e.ark.v1.IntentH\x00R\x06intent\x12\x14\n" +
	"\x04txid\x18\x02 \x01(\tH\x00R\x04txidB\f\n" +
	"\n" +
	"identifier\"J\n" +
