...
func (UnimplementedArkServiceServer) EstimateIntentFee(context.Context, *EstimateIntentFeeRequest) (*EstimateIntentFeeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EstimateIntentFee not implemented")
}
...
func (UnimplementedArkServiceServer) SubmitTreeNonces(context.Context, *SubmitTreeNoncesRequest) (*SubmitTreeNoncesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitTreeNonces not implemented")
}
func (UnimplementedArkServiceServer) SubmitTreeSignatures(context.Context, *SubmitTreeSignaturesRequest) (*SubmitTreeSignaturesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitTreeSignatures not implemented")
}
func (UnimplementedArkServiceServer) SubmitSignedForfeitTxs(context.Context, *SubmitSignedForfeitTxsRequest) (*SubmitSignedForfeitTxsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitSignedForfeitTxs not implemented")
}
...
func (UnimplementedArkServiceServer) UpdateStreamTopics(context.Context, *UpdateStreamTopicsRequest) (*UpdateStreamTopicsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateStreamTopics not implemented")
}
...
func (UnimplementedArkServiceServer) FinalizeTx(context.Context, *FinalizeTxRequest) (*FinalizeTxResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FinalizeTx not implemented")
}
func (UnimplementedArkServiceServer) GetPendingTx(context.Context, *GetPendingTxRequest) (*GetPendingTxResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPendingTx not implemented")
}
func (UnimplementedArkServiceServer) GetTransactionsStream(*GetTransactionsStreamRequest, grpc.ServerStreamingServer[GetTransactionsStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method GetTransactionsStream not implemented")
}
...
func RegisterArkServiceServer(s grpc.ServiceRegistrar, srv ArkServiceServer) {
	// If the following call panics, it indicates UnimplementedArkServiceServer was
