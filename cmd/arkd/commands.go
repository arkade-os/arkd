...
var (
	...
	updateSettingsCmd = &cli.Command{
		...
		Flags: []cli.Flag{
			...
			epochExpiryEnabledFlag, epochAnchorFlag, epochLengthFlag, rolloverWindowFlag, settlementCutoffFlag, unrollGraceFlag,
...
func updateSettingsAction(ctx *cli.Context) error {
	...
	intFields := []struct {
		...
		{settlementCutoffFlagName, "settlementCutoff"},
		{unrollGraceFlagName, "unrollGrace"},
