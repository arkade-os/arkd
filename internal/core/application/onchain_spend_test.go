...
func TestOnchainSpends(t *testing.T) {
	t.Run("apply records, skips and re-points spends", func(t *testing.T) {
	...
	t.Run("retract only on positive evidence of being unspent", func(t *testing.T) {
		out := outpoint(unrolledVtxoTxid, 0)
	...
	t.Run("reconcile once backfills and degrades", func(t *testing.T) {
		out := outpoint(unrolledVtxoTxid, 0)
	...
	// outpoint is gone.
	t.Run("first reconcile pass is unwindowed", func(t *testing.T) {
		out := outpoint(unrolledVtxoTxid, 0)
	...
	t.Run("watch records pushed spends", func(t *testing.T) {
		out := outpoint(unrolledVtxoTxid, 0)
