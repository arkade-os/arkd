...
var (
	intents = []domain.Intent{
		{
			Id:      "0",
			Proof:   "",
			Message: "message",
			Inputs: []domain.Vtxo{
				{
		...
		{
			Id:      "1",
			Proof:   "",
			Message: "message",
			Inputs: []domain.Vtxo{
				{
					Outpoint: domain.Outpoint{
