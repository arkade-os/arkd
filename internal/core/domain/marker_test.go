...
func TestMarkerTypes(t *testing.T) {
	t.Run("marker interval", func(t *testing.T) {
		require.Equal(t, uint32(100), uint32(MarkerInterval))
	})

	t.Run("marker struct", func(t *testing.T) {
		marker := Marker{
			ID:              "test-marker-id",
			Depth:           100,
	...
	t.Run("swept marker struct", func(t *testing.T) {
	...
	t.Run("root marker has no parents", func(t *testing.T) {
		rootMarker := Marker{
			ID:              "root-marker",
			Depth:           0,
			ParentMarkerIDs: nil,
...
func TestIsAtMarkerBoundary(t *testing.T) {
	t.Run("boundary detection", func(t *testing.T) {
		tests := []struct {
			depth    uint32
			expected bool
		}{
	...
	t.Run("depth at marker boundary", func(t *testing.T) {
		testCases := []struct {
			depth        uint32
			isAtBoundary bool
			description  string
...
func TestNewMarker(t *testing.T) {
	...
	t.Run("depth increment creates marker at boundary", func(t *testing.T) {
		testCases := []struct {
			parentDepth        uint32
			newDepth           uint32
	...
	t.Run("inheritance at non-boundary", func(t *testing.T) {
		testCases := []struct {
			name             string
			parentDepths     []uint32
	...
	t.Run("creation at boundary", func(t *testing.T) {
		testCases := []struct {
			name             string
			parentDepths     []uint32
			parentMarkerSets [][]string
	...
	t.Run("at depth 20k", func(t *testing.T) {
...
func TestDepthCalculation(t *testing.T) {
	t.Run("max parent depth plus one", func(t *testing.T) {
		testCases := []struct {
			name          string
			spentVtxos    []Vtxo
			expectedDepth uint32
	...
	t.Run("all new vtxos get same depth", func(t *testing.T) {
		testCases := []struct {
			name              string
			parentDepths      []uint32
			parentMarkerSets  [][]string
