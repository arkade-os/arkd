CREATE TABLE IF NOT EXISTS intent_fees (
    ...
    offchain_input_fee_program TEXT NOT NULL DEFAULT '0',
    onchain_input_fee_program TEXT NOT NULL DEFAULT '0',
    offchain_output_fee_program TEXT NOT NULL DEFAULT '0',
    onchain_output_fee_program TEXT NOT NULL DEFAULT '0'
);
