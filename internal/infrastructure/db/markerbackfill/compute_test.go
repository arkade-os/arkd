...
func TestComputeMarkersLinearChainBoundaries(t *testing.T) {
	const n = 205
	rows, txids := linearChain(n)
	vtxosByTxid, parentsByChildTxid := markerbackfill.BuildIndexes(rows)
...
func TestComputeDepthsDiamond(t *testing.T) {
...
func TestComputeMarkersDiamondUnion(t *testing.T) {
...
func TestComputeDepthsOrphanOmitted(t *testing.T) {
