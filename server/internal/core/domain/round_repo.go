...
type RoundRepository interface {
	...
	GetRoundConnectorTree(ctx context.Context, commitmentTxid string) ([]tree.TxGraphChunk, error)
	GetRoundVtxoTree(ctx context.Context, txid string) ([]tree.TxGraphChunk, error)
