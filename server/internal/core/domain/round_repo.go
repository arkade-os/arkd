...
type RoundRepository interface {
	...
	GetRoundConnectorTree(ctx context.Context, commitmentTxid string) ([]tree.TxTreeNode, error)
	GetRoundVtxoTree(ctx context.Context, txid string) ([]tree.TxTreeNode, error)
