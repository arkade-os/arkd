...
func BuildForfeitTxWithAnchor(
	...
	return BuildForfeitTxWithOutputAndAnchor(inputs, sequences, prevouts, forfeitOut, extensionAnchor, txLocktime)
}

func BuildForfeitTxWithOutputAndAnchor(
	inputs []*wire.OutPoint, sequences []uint32, prevouts []*wire.TxOut,
