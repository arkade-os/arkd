...
func init() {
	...
	if err := json.Unmarshal([]byte(`["INDEXER_CHAINED_TX_TYPE_UNSPECIFIED","INDEXER_CHAINED_TX_TYPE_ARK","INDEXER_CHAINED_TX_TYPE_TREE","INDEXER_CHAINED_TX_TYPE_CHECKPOINT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
